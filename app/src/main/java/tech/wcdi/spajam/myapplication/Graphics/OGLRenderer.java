...
import tech.wcdi.spajam.myapplication.Graphics.Rect.Square;
...
public class OGLRenderer implements GLSurfaceView.Renderer {
    ...
    private static final String TAG = "OGLRenderer";
     ...
     * OGLRenderer.checkGlError("glGetUniformLocation");</pre>
     * <p>
